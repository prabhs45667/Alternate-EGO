...
export default function OnboardingPage() {
    ...
    // Voice state
    const [questions, setQuestions] = useState<Array<{ index: number; text: string }>>([]);
    ...
    const handleVoiceUpload = async (blob: Blob) => {
        ...
        try {
            ...
            if (currentQuestion < questions.length - 1) {
                ...
                // All questions done, move to generating
                setStep("generating");
                handleComplete();
            }
        } catch (e) {
                ...
                <div style={{ position: 'relative', zIndex: 10, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center', gap: '12px' }}>
                            ...
                            <button onClick={skipQuestion} disabled={isRecording} style={{
                    ...
                    <motion.p
                        ...
                        style={{ color: 'rgba(255,255,255,0.25)', fontSize: '0.75rem', marginTop: '1.5rem', textAlign: 'center' }}
                    >
                        💡 Speak naturally — your voice will be used to clone your twin&apos;s speech
                    </motion.p>
                </div>
            </div>
        );

                                    ...
                                    <div style={{ maxWidth: "65%" }}>
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "4px", padding: "0 4px", justifyContent: msg.role === "user" ? "flex-end" : "flex-start" }}>
                                            ...
                                            {msg.role === "assistant" && msg.audio_url && (
                                                <button onClick={() => playAudio(msg.audio_url!)} style={{ background: "none", border: "none", cursor: "pointer", fontSize: "0.7rem", color: "#4ade80", display: "flex", alignItems: "center", gap: "3px", transition: "opacity 0.2s" }}

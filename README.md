...
| Nano Banana 2 Avatar | 4 Emotion Photos + face-api.js CV | Browser-side emotion validation |
...
- Neutral photo used as default avatar
...
- **Landing Page** — Hero with animated face swap (3D flip), orbital particles, glassmorphism UI
...
├── ego_system_design.md.resolved          # Original system design & architecture
├── ego_team_script.md.resolved            # Team briefing (Hindi/English)
├── XTTS-v2/                               # Coqui voice cloning model (~2GB)
├── screenshots/                           # Original Ego hackathon screenshots
│   ├── step1.png → step9.png
├── alternate-ego/
│   ├── backend/
